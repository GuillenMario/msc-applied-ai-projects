...
**Note:** This repository is still a **work in progress**. The following notebooks have been fully polished and prepared for portfolio review:
* 01 — Basic Data Transformations & Linear Regression
* 02 — Employee Attrition Analysis (IBM HR Dataset)
The remaining modules are currently in draft/unpolished form and will be updated progressively.
